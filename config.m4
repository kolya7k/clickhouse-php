...
if test "$PHP_CLICKHOUSE" != "no"; then
	...
	PHP_ADD_LIBRARY(clickhouse-cpp-lib, 1, CLICKHOUSE_SHARED_LIBADD)
 	...
 	CXXFLAGS="-fPIC -mno-sse4.2 -mno-sse4.1 -O2 -g3 -std=gnu++20 -Wall -Wextra -Wdeprecated -Wno-unused-parameter -Wredundant-decls -Wlogical-op -Wtrampolines -Wduplicated-cond -Wsuggest-override -Wdouble-promotion -Wno-unknown-pragmas -Wcast-qual -pedantic -pedantic-errors -fno-omit-frame-pointer -include defines.h -Isrc"
